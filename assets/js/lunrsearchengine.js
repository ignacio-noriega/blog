...
function lunr_search(term) {
    ...
    if(term) {
        ...
        if(results.length>0){
            ...
            document.querySelectorAll('#lunrsearchresults ul')[0].innerHTML = "<li class='lunrsearchresult'>No se encontraron resultados. Cierra e intenta una nueva búsqueda.</li>";
        }
    }
    return false;
}
